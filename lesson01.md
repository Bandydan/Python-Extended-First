...
2. Нарисовать блок-схему программы **envelops.py**.
3. Написать отзывы о программе **envelops.py**: список того, что нравится, что не нравится, что, по вашему мнению, можно улучшить.
4. Подготовить список вопросов обо всем, что было за урок непонятного.
5. Приступить к настройке среды для разработки на python на своем компьютере(sublime text3, python 2.7).
6. Все списки и блок-схемы оформить в электронном виде и выложить на google disk в свою папку, приглашение на которую должно прийти к вам на почту.
